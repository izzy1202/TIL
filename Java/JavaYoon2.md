...
#### 4.1.10. 다음과 같이 구현 가능
![image](https://github.com/izzy1202/TIL/assets/106478906/3fa5be61-96d5-411a-a136-e7ca4198a2ce)

#### 4.1.11. 배열의 탐색: 기본 자료형 값 대상
> 탐색의 목적
1. 있나 없나
2. 어디에 저장된지 위치 확인
-> 보통 탐색의 대상은 배열인 경우 많다.

- public static int binarySearch(int[] a, int key)
→ 배열 a에서 key를 찾아서 있으면 key의 인덱스 값, 없으면 0보다 작은 수 반환

- binarySearch는 이진 탐색을 진행! 그리고 이진 탐색을 위해서는 탐색 이전에 데이터들이 오름차순으로 정렬되어 있어야 한다.

#### 4.1.12 배열의 탐색: 기본 자료형 값 대상의 예
- 탐색 전 sort로 정렬부터 해야 한다.

#### 4.1.13 배열의 탐색: 인스턴스 대상
> public static int binarySearch(Object[] a, Object key)

- 마찬가지로 탐색 대상들은 오름차순으로 정렬되어 있어야 한다. 그리고 탐색 대상의 확인 여부는 compareTo 메소드의 호출 결과를 근거로 한다. 즉, 탐색 방식은 인스턴스의 내용 비교이다!
